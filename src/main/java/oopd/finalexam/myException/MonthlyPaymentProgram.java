...
public class MonthlyPaymentProgram {
	public void start() throws CreditCardException, LoanAmountException, PayMonthlyException, NumberFormatException{
		String credit_no;
		double loan_amount;
		int number_of_month;
	...
	public String getCreditCardNo(String temp) throws CreditCardException{
		...
		if (temp.length() != 5)
		{
			throw new CreditCardException("Enter 5 characters of credit card no:");
		}
	...
	public double getLoanAmount(String temp) throws LoanAmountException,NumberFormatException , CreditCardException {
		try {
			...
			if (amount >= 50_000 && amount <= 1_000_000)
			{
				return amount;
			}
			...
			{
				throw new LoanAmountException("Enter loan amount (50,000-1,000,0000): ");
			}
	...
	public int getNoOfMonth(String temp ) throws PayMonthlyException,NumberFormatException {
		try {
			...
			{
				throw new  PayMonthlyException("The number of month for paying monthly must be between 2 to 48 months");
			}
	...
	public static void main(String[] args) throws LoanAmountException, PayMonthlyException, CreditCardException {
